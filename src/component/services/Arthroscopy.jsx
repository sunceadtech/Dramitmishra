              ...
              <section className="py-10 bg-white">
                <div className="container mx-auto px-4 text-gray-700">
                  ...
                  <ul className="list-disc list-inside mb-6 space-y-2">
                    <li>✔️ Torn meniscus in the knee</li>
                    <li>✔️ Damaged cartilage or ligaments</li>
                    <li>✔️ Loose bone or cartilage fragments</li>
                    <li>✔️ Inflamed joint linings (synovitis)</li>
                    <li>✔️ Shoulder impingement or rotator cuff tears</li>
                  </ul>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li>✔️ Physical examination and imaging (MRI, X-ray)</li>
                      <li>
                        ✔️ Anesthesia planning – local, spinal, or general
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li>✔️ Small incisions made near the joint</li>
                      <li>✔️ Arthroscope inserted for internal joint view</li>
                      <li>✔️ Surgical tools used to treat damaged tissues</li>
                      <li>✔️ Joint irrigated and incisions closed</li>
                    </ul>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li>✔️ Outpatient procedure – same day discharge</li>
                      <li>✔️ Mild pain managed with medications</li>
                      <li>✔️ Rehabilitation and physical therapy</li>
                      <li>✔️ Full recovery within weeks depending on joint</li>
                    </ul>
                  </div>

                  <h3 className="text-2xl font-semibold mb-4">Benefits</h3>
                  <ul className="list-disc list-inside space-y-2">
                    <li>✔️ Smaller incisions and minimal scarring</li>
                    <li>✔️ Quicker recovery time</li>
                    <li>✔️ Less post-operative pain</li>
                    <li>✔️ Accurate joint diagnosis and treatment</li>
                  </ul>
                </div>
              </section>
