          ...
          renderArrowPrev={(onClickHandler, hasPrev, label) =>
            hasPrev && (
              <button
                ...
                className="absolute left-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full shadow-md bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
          ...
          renderArrowNext={(onClickHandler, hasNext, label) =>
            hasNext && (
              <button
                ...
                className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 rounded-full shadow-md bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
